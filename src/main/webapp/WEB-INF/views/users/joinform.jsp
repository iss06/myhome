		...
		<div id="wrapper">
			<div id="content">
				...
				<form method="POST" action="<%=request.getContextPath()%>/users">
					...
					<input type="text" name="name" /><br /> <label for="password">비밀번호</label>
					<input type="password" name="password" /><br /> <label
						for="email">이메일</label> <input type="text" name="email" /><br />
					<label for="gender">성별</label> <input type="radio" name="gender"
						value="M" checked> 남성 <input type="radio" name="gender"
						value="F"> 여성 <input type="submit" value="가입" />
